...
import JsonDbSettings from "@/ee09/json-db-ui/json-db-settings";
import AdminDialogNav from "@/ee09/json-db-ui/nav/admin-dialog-nav";
import RecordTableLine from "@/ee09/json-db-ui/records/record-table-line";
import BtnsRecordAction from "@/ee09/json-db-ui/records/btns/btns-record-action";
export default {
  name: "admin-dialog",
